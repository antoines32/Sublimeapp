...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Cw9K1Aqxqe', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BL9Y8-8T6N', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rKdbxSnISt', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iL0LBw6JcF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f10790b5272743483c1ab335233df870107c1b27')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MenuBundle/Resources/views'), '!Menu');
        $instance->addPath(($this->targetDirs[3].'\\src\\SocieteBundle/Resources/views'), 'Societe');
        $instance->addPath(($this->targetDirs[3].'\\src\\SocieteBundle/Resources/views'), '!Societe');
        $instance->addPath(($this->targetDirs[3].'\\src\\LegalBundle/Resources/views'), 'Legal');
        $instance->addPath(($this->targetDirs[3].'\\src\\LegalBundle/Resources/views'), '!Legal');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f10790b5272743483c1ab335233df870107c1b27');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WebsiteBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\WebsiteBundle'),
                    'namespace' => 'WebsiteBundle',
                ),
                'MenuBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MenuBundle'),
                    'namespace' => 'MenuBundle',
                ),
                'SocieteBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\SocieteBundle'),
                    'namespace' => 'SocieteBundle',
                ),
                'LegalBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\LegalBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SocieteBundle' => 'SocieteBundle\\SocieteBundle',
                'LegalBundle' => 'LegalBundle\\LegalBundle',
            ...
            'secret' => 'f10790b5272743483c1ab335233df870107c1b27',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f10790b5272743483c1ab335233df870107c1b27',
